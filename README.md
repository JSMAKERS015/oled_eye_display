...
To program the Arduino Nano, upload the "control_display.ino" file, which will handle drawing and communication with the computer. Use the Arduino IDE to compile and upload the code. Make sure the Nano is connected to the computer during this process.
...
1.  Go to **Tools > Board > Arduino Uno**. Copy the code and paste it into your IDE.
